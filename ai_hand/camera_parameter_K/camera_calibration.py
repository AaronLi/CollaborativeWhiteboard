...
def calibrate_camera(cal_img_path):
    ...
    for img_fname in images:
        ...
        if ret==True:
            ...
            chessboard = cv2.drawChessboardCorners(chessboard, (9, 9), corners, ret)
            cv2.imshow("waow", chessboard)
            cv2.waitKey(10)
...
if __name__ == "__main__":
    calibrate_camera("ai_hand/camera_parameter_K/calibration_images")
